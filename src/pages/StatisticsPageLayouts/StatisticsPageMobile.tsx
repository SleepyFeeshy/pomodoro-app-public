...
export default function StatisticsPageMobile() {
  ...
  return (
    <main className="flex h-[calc(100vh-128px)] md:h-fit flex-col overflow-y-scroll md:overflow-y-auto pb-[calc(36px+env(safe-area-inset-bottom))] pt-2 md:pt-0 md:pb-0">
      <div className="grid grid-cols-1 gap-1 px-2 md:max-w-[65em] mx-auto ">
